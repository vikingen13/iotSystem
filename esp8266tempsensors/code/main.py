...
def writeTextToOled(aOled,aText,x=0,y=0):
    aOled.fill(0)
    myTextLines = aText.split('\n')
    myY=y
    for myText in myTextLines:
        aOled.text(myText,x,myY)
        myY+=10
    aOled.show()
...
writeTextToOled(oled,"temperature is \n {}C".format(myTemperature))
